...
class PomodoroTimer:
    ...
    def __init__(self):
        ...
        self.root.tk.call('wm','iconphoto',self.root._w, PhotoImage(file="—Pngtree—alarm clock vector eps_4185619.png"))
        ...
        self.start_button = ttk.Button(self.grid_layout, text="Start", command=self.start_time_thread)
